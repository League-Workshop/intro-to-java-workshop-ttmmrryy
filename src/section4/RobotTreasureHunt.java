...
public class RobotTreasureHunt implements KeyEventDispatcher{
	...
	private void spaceBarWasPressed() {
		...
		int robotXLocation = Kellen.getX();
		int robotYLocation = Kellen.getY();
		...
		if(710 < robotXLocation && robotXLocation< 750 && 375 < robotYLocation && robotYLocation < 425) {
			JOptionPane.showMessageDialog(null, "Go to the skull for your next instructions.");
		}
		else if(710 < robotXLocation && robotXLocation< 750 && 375 < robotYLocation && robotYLocation < 425) {
			JOptionPane.showMessageDialog(null, "Go to the skull for your next instructions.");
		}
