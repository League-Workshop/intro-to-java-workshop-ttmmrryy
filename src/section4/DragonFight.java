	...
	public static void main(String[] args) {
		...
		// 10. If they typed in "kick":
			...
			//-- Find a random number between 0 and 25 and store it in dragonDamage
				dragonDamage = new Random().nextInt(26)+ 5;
			//-- Subtract that number from the dragon's health variable
				dragonHealth = dragonHealth - dragonDamage;
		...
		// 12. Subtract this number from the player's health
			...
			if(dragonHealth <= 0 && playerHealth <= 0) {
				JOptionPane.showMessageDialog(null, "You are both dead.");
			}
		// 13. If the user's health is less than or equal to 0
			...
			//-- Tell the user that the dragon is dead and they took a ton of gold!
				JOptionPane.showMessageDialog(null, "The dragon is dead and you took a lot of gold!!");
			}
	   ...
	   //  15.  Else
				...
				JOptionPane.showMessageDialog(null, "The dragon's current health is " + dragonHealth + ".");
			}
